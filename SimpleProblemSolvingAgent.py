...
class SimpleProblemSolvingAgent():
    def __init__(self, graphProblem):
        self.graph = graphProblem.graph
        self.state = graphProblem.initial
        self.goal = graphProblem.goal
        self.seq = []
    ...
    def __call__(self):
        ...
        print("Cost:", best_first_graph_search(romania_problem, lambda n: romania_problem.h(n)).path_cost)
        print("Path: ", bfgs_final_path)
        print("")
        astar_final_path = astar_search(romania_problem).solution()
        astar_final_path.insert(0, self.state)
        print("A* Search")
